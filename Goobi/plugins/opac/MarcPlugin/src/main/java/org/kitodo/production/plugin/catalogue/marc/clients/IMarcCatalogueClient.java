...
/**
 * Interface for a marc catalogue client.
 */
public interface IMarcCatalogueClient {
     ...
     */
    InputStream query(String urlString, Map<String, String> params, long timeout) throws Exception;
